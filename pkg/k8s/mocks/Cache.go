...
// GetMigration provides a mock function with given fields: namespace, name
func (_m *Cache) GetMigration(namespace string, name string) (*v1beta1.Mig, error) {
	ret := _m.Called(namespace, name)

	var r0 *v1beta1.Mig
	if rf, ok := ret.Get(0).(func(string, string) *v1beta1.Mig); ok {
		r0 = rf(namespace, name)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v1beta1.Mig)
		}
	}
...
func (_m *Cache) ListMigrations(namespace string, labelSelectorStr string) ([]*v1beta1.Mig, error) {
