	...
	tests := []struct{
		...
		},
		{
			initMock: func() {
				...
				mockHelm.On("InstallOrCreateReleaseWithStrict", mock.Anything, mock.Anything, mock.Anything, true, false, (*release.ReleaseInfoV2)(nil), false, true, true).Return(&release.ReleaseCache{Manifest: "test-manifest"}, nil)
