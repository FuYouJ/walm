	...
	tests := []struct {
		...
		},
		{
			initMock: func() {
				...
				mockHelm.On("InstallOrCreateReleaseWithStrict", mock.Anything, mock.Anything, mock.Anything, mock.Anything, false, mock.Anything, false, mock.Anything, mock.Anything).Return(&release.ReleaseCache{}, nil)
