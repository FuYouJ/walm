	...
	tests := []struct {
		...
		},
		{
			initMock: func() {
				...
				mockKafka.On("SyncSendMessage", kafka.ReleaseConfigTopic, "{\"type\":\"Delete\",\"data\":{\"name\":\"testnm\",\"namespace\":\"testns\",\"kind\":\"\",\"state\":{\"status\":\"\",\"reason\":\"\",\"message\":\"\"},\"labels\":null,\"configValues\":null,\"dependenciesConfigValues\":null,\"dependencies\":null,\"chartName\":\"\",\"chartVersion\":\"\",\"chartAppVersion\":\"\",\"outputConfig\":null,\"repo\":\"\",\"chartImage\":\"\",\"isomateConfig\":null,\"releaseWalmVersion\":\"\"}}").Return(nil)
			},
		},
		{
			initMock: func() {
		...
		},
		{
			initMock: func() {
				...
				mockKafka.On("SyncSendMessage", kafka.ReleaseConfigTopic, "{\"type\":\"CreateOrUpdate\",\"data\":{\"name\":\"testnm\",\"namespace\":\"testns\",\"kind\":\"\",\"state\":{\"status\":\"\",\"reason\":\"\",\"message\":\"\"},\"labels\":null,\"configValues\":null,\"dependenciesConfigValues\":null,\"dependencies\":null,\"chartName\":\"\",\"chartVersion\":\"\",\"chartAppVersion\":\"\",\"outputConfig\":null,\"repo\":\"\",\"chartImage\":\"\",\"isomateConfig\":null,\"releaseWalmVersion\":\"v2\"}}").Return(nil)
			},
		},
	}
