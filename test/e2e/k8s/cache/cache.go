...
var _ = Describe("K8sCache", func() {
	...
	BeforeEach(func() {
		...
		k8sCache = informer.NewInformer(framework.GetK8sClient(), framework.GetK8sReleaseConfigClient(), framework.GetK8sInstanceClient(), framework.GetK8sMigrationClient(), nil, 0, stopChan)
	})
