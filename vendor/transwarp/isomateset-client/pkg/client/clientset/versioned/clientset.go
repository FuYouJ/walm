...
import (
	...
	apiextensionsv1alpha1 "transwarp/isomateset-client/pkg/client/clientset/versioned/typed/apiextensions.transwarp.io/v1alpha1"
)
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.apiextensionsV1alpha1, err = apiextensionsv1alpha1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
