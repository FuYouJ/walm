...
import (
	"transwarp/isomateset-client/pkg/client/clientset/versioned/scheme"
...
// ApiextensionsV1alpha1Client is used to interact with features provided by the apiextensions.transwarp.io group.
type ApiextensionsV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ApiextensionsV1alpha1Client) IsomateSets(namespace string) IsomateSetInterface {
	return newIsomateSets(c, namespace)
}
