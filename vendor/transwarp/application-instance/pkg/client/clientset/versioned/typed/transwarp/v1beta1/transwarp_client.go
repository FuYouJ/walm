...
import (
	...
	"transwarp/application-instance/pkg/client/clientset/versioned/scheme"
...
func (c *TranswarpV1beta1Client) ApplicationInstances(namespace string) ApplicationInstanceInterface {
