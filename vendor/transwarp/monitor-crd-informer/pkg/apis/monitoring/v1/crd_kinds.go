...
var DefaultCrdKinds = CrdKinds{
	KindsString:    "",
	Prometheus:     CrdKind{Plural: PrometheusName, Kind: PrometheusesKind, SpecName: "transwarp/monitor-crd-informer/pkg/apis/monitoring/v1.Prometheus"},
	ServiceMonitor: CrdKind{Plural: ServiceMonitorName, Kind: ServiceMonitorsKind, SpecName: "transwarp/monitor-crd-informer/pkg/apis/monitoring/v1.ServiceMonitor"},
	PodMonitor:     CrdKind{Plural: PodMonitorName, Kind: PodMonitorsKind, SpecName: "transwarp/monitor-crd-informer/pkg/apis/monitoring/v1.PodMonitor"},
	Alertmanager:   CrdKind{Plural: AlertmanagerName, Kind: AlertmanagersKind, SpecName: "transwarp/monitor-crd-informer/pkg/apis/monitoring/v1.Alertmanager"},
	PrometheusRule: CrdKind{Plural: PrometheusRuleName, Kind: PrometheusRuleKind, SpecName: "transwarp/monitor-crd-informer/pkg/apis/monitoring/v1.PrometheusRule"},
	ThanosRuler:    CrdKind{Plural: ThanosRulerName, Kind: ThanosRulerKind, SpecName: "transwarp/monitor-crd-informer/pkg/apis/monitoring/v1.ThanosRuler"},
}
