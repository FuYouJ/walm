...
import (
	...
	"github.com/migration/pkg/client/clientset/versioned/scheme"
...
// ApiextensionsV1beta1Client is used to interact with features provided by the apiextensions.tos.io group.
type ApiextensionsV1beta1Client struct {
	restClient rest.Interface
}

func (c *ApiextensionsV1beta1Client) Migs(namespace string) MigInterface {
	return newMigs(c, namespace)
}
